...
print(os.getcwd())
dividir_guardar_imagen("assets//images//tiles//mainlevbuild.png", "assets//images//tiles",64)  #IMPORTANTE COLOCAR BIEN LA CANTIDAD DE COLUMNAS, SIEMPRE ES UNA MAS QUE EN TILED   #Dungeon_Tileset.png    mainlevbuild.png
